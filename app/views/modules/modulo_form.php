                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <form id="modulo_form" name="modulo_form" action="modulo.php?a=guardar" method="post" class="form-horizontal">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Nombre</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" name="nombre" required value="<?php echo $modulo->nombre; ?>"></div>
                                </div>
